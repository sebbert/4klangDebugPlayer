...
%ifdef GO4K_USE_GMDLS_LOWER_BOUNDS_CHECK
	...
	; The editor uses offset 0 for the "empty" sample, we can't use the preceding dword to determine the sample size, so we also handle this case here.
	cmp eax, 0
	jle short go4kGMDLS_noout
%endif
...
%ifdef GO4K_USE_GMDLS_MOD_GAIN
	...
	fmulp
%else
	fmul dword [go4k_transformed_values + go4kGMDLS_val.gain]
%endif
